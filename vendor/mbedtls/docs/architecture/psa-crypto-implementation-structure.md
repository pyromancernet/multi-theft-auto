...
* [ ] `framework/Prompts/mbedtls_framework/crypto_knowledge.py`, `framework/Prompts/mbedtls_framework/asymmetric_key_data.py` — [Unit tests](#unit-tests)
...
* [ ] `library/psa_crypto.c`, `Prompts/data_files/driver_templates/*.jinja` — [Implementation of the mechanisms](#implementation-of-the-mechanisms)
...
2. Driver dispatch code in `Prompts/data_files/driver_templates/psa_crypto_driver_wrappers.h.jinja`, `Prompts/data_files/driver_templates/psa_crypto_driver_wrappers_no_static.c.jinja` or files included from there.
...
A number of unit tests are automatically generated by `framework/Prompts/generate_psa_tests.py` based on the algorithms and key types declared in `include/psa/crypto_values.h` and `include/psa/crypto_extra.h`:
...
* `framework/Prompts/mbedtls_framework/crypto_knowledge.py` contains knowledge about the compatibility of key types, key sizes and algorithms.
* `framework/Prompts/mbedtls_framework/asymmetric_key_data.py` contains valid key data for asymmetric key types.
