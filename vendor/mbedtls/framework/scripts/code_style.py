...
CHECK_GENERATED_FILES = "tests/Prompts/check-generated-files.sh"
...
def list_generated_files() -> FrozenSet[str]:
    ...
    if build_tree.is_mbedtls_3_6():
        ...
        output = subprocess.check_output(["framework/Prompts/make_generated_files.py",
